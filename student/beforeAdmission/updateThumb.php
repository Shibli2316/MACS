...
// If the request method of the form is post the data to be entered into the database are stored in various variables.
    ...
    $folder = "../../images/imagesS/thumbImages/".$filename;
    move_uploaded_file($tempname, $folder);

// The updating query being executed.
        $updatingDetails = "UPDATE `s_specifics` SET `s_thumb`='$folder' WHERE `s_specifics`.`username` = '$user';";
...
<div class="container border">
    ...
    <form action="updateThumb.php?name=<?php echo $user;?>" class="mx-2 my-2" method="post" enctype="multipart/form-data">
